...
Запустите анализ на версии 7.0.0 и разметьте две **разные** сработки, полученные в результате анализа (чтобы найти сработки может потребоваться включить расширенный набор security-чекеров).
