...
### CodeQL и анализ krew
Проведем анализ проекта krew (https://github.com/kubernetes-sigs/krew) версии 0.3.0 (`git checkout v0.3.0`) с помощью CodeQL и посмотрим на результаты.
...
Запустите анализ на версии 0.3.0 и разметьте две **разные** сработки, полученные в результате анализа (чтобы найти сработки может потребоваться включить расширенный набор security-чекеров).
