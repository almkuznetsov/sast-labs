...
В ходе этой работы мы воспользуемся различными статическими анализаторами, чтобы рассмотреть примеры уязвимостей. Мы найдем их в исходном коде программ, подготовим исправления и убедимся, что уязвимости закрыты. На этих примерах мы познакомимся с реальным циклом анализа программ и подготоки патчей безопасности.
...
## Changelog
* Mon Mar 30 2026 Alexander Kuznetsov <kuznetsovam@altlinux.org> v4.3
	- sast-7: проект для анализа codeql изменен с geoipupdate на krew.
	- sca-4: добавлена часть 4.

* Mon Mar 23 2026 Alexander Kuznetsov <kuznetsovam@altlinux.org> v4.2
	- sast-7: добавлена заметка про дополнительные детекторы codeql.
	- sca-2,3: добавлены части 2 и 3.

* Mon Mar 16 2026 Alexander Kuznetsov <kuznetsovam@altlinux.org> v4.1
	- sast-7, sca-1: добавлена часть 7 и часть 1 sca.

* Mon Feb 09 2026 Alexander Kuznetsov <kuznetsovam@altlinux.org> v4.0
	- sast-5,6: добавлены части 5 и 6.
